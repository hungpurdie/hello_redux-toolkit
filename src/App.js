...
import { decrement, increment } from 'store/counter/counterAction';
...
function App(props) {
  ...
  return (
    <div className="App">
      <h1 style={{ color: 'green' }}>Counter Parent connect store: {countNumberProps}</h1>
      <button onClick={handleIncrementConnectStore}>Increment Parent connect store</button>
      ...
      <Counter countNumberProps={countNumberProps} incrementProps={incrementProps} />
    </div>
  );
}
